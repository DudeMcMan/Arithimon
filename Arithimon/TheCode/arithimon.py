...
def main():
    ...
    continueButtonClick = pygame.USEREVENT + 8
    ...
    continueButton = Button(screen, 'Click To Continue', 600, 40, (375, 580), 5, continueButtonClick, pygame.K_RETURN, pygame.K_KP_ENTER)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == returnButtonClick: #Back to diffSelect
                ...
                butthead = 0
                diffSelectButtonsActive = True
            elif event.type == answerButtonClick and playerTurn and not frank:
                if userText != "Input\u00A0Here" and userText != "":
                    answered = True
            elif event.type == continueButtonClick and frank:
                correct = False
                answered = False
                textActive = False
                playerTurn = False
